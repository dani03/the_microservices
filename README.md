...
```
cd existing_repo
git remote add origin https://gitlab.com/group-quiz-dev/quiz-dev.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/group-quiz-dev/quiz-dev/-/settings/integrations)
